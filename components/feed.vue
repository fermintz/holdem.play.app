<template>
  <div class="border-t border-solid border-t-neutral-200 p-5">
    <div class="flex items-center">
      <img src="~/assets/img/profile01.png" class="block w-10 h-10 bg-cover rounded-full" @click="$router.push('league_detail')">
      <div class="ml-3">
    ...
    <div class="image rounded-xl mt-5 relative">
      ...
      >
        <swiper-slide>
          <img src="~/assets/img/P01-1.jpeg" class=" object-cover w-full h-full object-top"  @click="visible = true"/>
        </swiper-slide>
        <swiper-slide>
          <img src="~/assets/img/P01-2.jpeg" class=" object-cover w-full h-full object-top"  @click="visible = true"/>
        </swiper-slide>
