<template>
  <div class="rounded-lg overflow-hidden" > <!-- 시드권 컴포넌트 -->
    ...
    <div class="flex items-center justify-end p-4 border border-solid border-gray-300 rounded-b-lg border-t-0">
      <span class="block text-xs text-gray-500">보유수량</span>
